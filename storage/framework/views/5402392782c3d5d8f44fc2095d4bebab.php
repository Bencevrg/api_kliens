            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-end gap-2 mb-4">
                        <a href="<?php echo e(route('writers.export', 'csv')); ?>" 
                        ...
                        <a href="<?php echo e(route('writers.export', 'pdf')); ?>" 
                           class="text-white font-bold py-2 px-4 rounded text-sm"
                    ...
                    <?php if(session('api_token')): ?>
                        <div class="mb-4">
                            <a href="<?php echo e(route('writers.create')); ?>" 
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $writers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $writer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><?php echo e($writer['id']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap font-bold"><?php echo e($writer['name']); ?></td>
                                    <td class="px-6 py-4"><?php echo e(Str::limit($writer['bio'] ?? '', 50)); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="<?php echo e(route('writers.books.index', $writer['id'])); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Könyvei</a>

                                        <?php if(session('api_token')): ?>
                                            <a href="<?php echo e(route('writers.edit', $writer['id'])); ?>" class="text-yellow-600 hover:text-yellow-900 mr-3">Szerkesztés</a>
                                            
                                            <form action="<?php echo e(route('writers.destroy', $writer['id'])); ?>" method="POST" class="inline-block" onsubmit="return confirm('Biztosan törölni szeretnéd?');">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\konyvek-api-client\resources\views/writers/index.blade.php ENDPATH**/ ?>