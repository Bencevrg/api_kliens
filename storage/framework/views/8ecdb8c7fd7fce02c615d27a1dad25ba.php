...
<body>
    ...
    <footer>
        Készült: <?php echo e(date('Y.m.d H:i')); ?> | Oldal: <span class="pagenum"></span>
    </footer>
    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo e($writer['id']); ?></td>
                    <td><?php echo e($writer['name']); ?></td>
                    <td><?php echo e(\Illuminate\Support\Str::limit($writer['bio'] ?? '', 100)); ?></td>
                </tr>
...
</html><?php /**PATH C:\xampp\htdocs\konyvek-api-client\resources\views/writers/pdf.blade.php ENDPATH**/ ?>